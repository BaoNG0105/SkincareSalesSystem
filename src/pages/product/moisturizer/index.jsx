    ...
    const fetchProducts = async () => {
      try {
        ...
        if (response.data) {
          ...
          const moisturizerProducts = response.data.filter(product => 
            product.category.toLowerCase() === 'moisturizer'
          );
          setProducts(moisturizerProducts);
        } else {
          setProducts([]);
        }
      } catch (err) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-pink-600 mb-12">Our Moisturizer Collection</h2>

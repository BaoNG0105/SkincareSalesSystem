      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="relative h-[300px] bg-pink-600">
          ...
          <div className="relative container mx-auto px-4 h-full flex items-center justify-center">
            <h1 className="text-4xl font-bold text-white">Face Mask Products</h1>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Our Face Mask Collection</h2>

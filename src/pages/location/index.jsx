        ...
        <div className="relative container mx-auto px-4 h-full flex items-center justify-center">
          <div className="text-center space-y-6">
            ...
            <p className="text-gray-600 text-xl max-w-2xl mx-auto leading-relaxed">
              Come visit our stores to experience the best skincare products and
              services{" "}
            </p>
          </div>
        </div>
              ...
              <div className="mb-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                  ...
                  <p className="text-gray-600 mb-2">
                    Address: 180, Xo Viet Nghe Tinh Street, Binh Thanh District,
                    Ho Chi Minh City
                  </p>
                  <p className="text-gray-600 mb-2">
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <p className="text-gray-600 mb-2">
                    Address: 4th Floor, Takashimaya Vietnam, 92-94 Nam Ky Khoi
                    Nghia, Ben Nghe Ward, District 1, Ho Chi Minh City
                  </p>
                  <p className="text-gray-600 mb-2">
                    <span className="font-semibold">Hotline:</span>{" "}
                    +091.103.1534
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                  ...
                  <p className="text-gray-600 mb-2">
                    Address: 1st Floor, AEON MALL Long Bien, No. 27, Cổ Linh
                    Street, Long Bien District, Hanoi
                  </p>
                  <p className="text-gray-600 mb-2">
                    <span className="font-semibold">Hotline:</span>{" "}
                    +091.979.7383
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <p className="text-gray-600 mb-2">
                    Address: Park 6, Vinhomes Times City, Hai Ba Trung District,
                    Hanoi
                  </p>
                  <p className="text-gray-600 mb-2">
                    <span className="font-semibold">Hotline:</span>{" "}

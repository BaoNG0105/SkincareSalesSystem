...
import { getRoutinesByTestResult, getRecommendedProducts } from "../../services/api.skinTest";
                ...
                {routineData ? (
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8">
                        {routineData.map((step) => (
                            <div key={`routine-${step.routineId}`} className="mb-12 last:mb-0">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                                {step.products.map((product) => (
                                                    <div key={`routine-product-${step.routineId}-${product.productId}`}
                    ...
                    <div className="text-center text-gray-600 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8">
                        ...
                        <p className="text-xl">No routine data available for your skin type.</p>
                    </div>
                )}
            </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 mt-8">
                        <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                            ...
                            <span className="bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">
                                Sản phẩm được đề xuất cho loại da {recommendedProducts[0]?.skinType?.skinType}
                            </span>
                        </h2>

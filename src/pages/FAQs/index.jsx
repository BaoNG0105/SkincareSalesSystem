...
function FAQsPage() {
  const faqs = {
    ...
    "Product Issues": [
      ...
      {
        question:
          "What should I do if a product causes irritation or an allergic reaction?",
        answer:
          "If you experience irritation (redness, itching, or swelling) immediately after using a product, discontinue use and rinse the affected area thoroughly. If the condition does not improve or worsens, seek advice from a dermatologist. Always perform a patch test on a small area of your skin before applying a new product to your entire face.",
      },
      {
        question:
          "I feel the product is not as effective as described. Should I adjust how I use it?",
        answer:
      ...
      {
        question:
          "If I have opened a product but haven't used it completely and it has a defect, can I return it?",
        answer:
          "Generally, opened products can only be returned if the defect is due to manufacturing errors or packaging mistakes. Be sure to read the return policy carefully and contact customer service for detailed guidance.",
      },
    ],
    "Shipping & Delivery": [
      {
        ...
        answer:
          "Shipping time depends on the location and shipping method. Typically, orders within the city are delivered within 1-3 business days, while orders in remote areas may take 3-7 business days. Specific information will be displayed when placing an order.",
      },
      {
        question: "How are shipping fees calculated?",
        answer:
          "Shipping fees are calculated based on the weight, size of the order, and distance from the warehouse to the delivery address. In some cases, orders of high value may qualify for free shipping. You can view detailed shipping costs during checkout.",
      },
      {
        question: "Can I request same-day or express delivery?",
        answer:
          "Some areas offer same-day or priority shipping services. Information about these options will be displayed during checkout, and you can select the most suitable option.",
      },
      {
        question:
          "If my order is returned due to shipping issues, will the shipping fee be refunded?",
        answer:
          "If an order is returned due to an error by the shipping company, the shipping fee is typically refunded. However, if the issue is due to incorrect information provided by the customer, the shipping fee may not be refunded according to the company's policy.",
      },
      {
        question:
          "Can my order be delivered to an office or a non-residential location?",
        answer:
          "Yes, you can provide an office or any other location where someone can receive the package. However, ensure that the address has a recipient available to avoid return issues.",
      },
      {
        question:
          "If I want my order delivered within a specific time frame, is that possible?",
        answer:
          "Some delivery partners allow customers to choose a specific delivery time. If you have special requests, note them in the order comments section or contact customer service for additional assistance.",
      },
    ],
  };
  ...
  const toggleFAQ = (category, index) => {
    // This is used to toggle the open FAQ
    setOpenIndex((prev) => ({
      ...prev,
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center justify-center">
          <div className="text-center space-y-6">
            ...
            <p className="text-gray-600 text-xl max-w-2xl mx-auto leading-relaxed">
              Find answers to common questions and concerns about our skincare
